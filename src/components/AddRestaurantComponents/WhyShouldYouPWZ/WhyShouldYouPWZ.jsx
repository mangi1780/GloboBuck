...
let WhyShouldYouPWZ = () => {
    return <div className={css.outerDiv}>
        <div className={css.innerDiv}>
            <div className={css.title}>Why should you partner with GloboBuck?</div>
            <div className={css.tagLine}>GloboBuck enables you to get 60% more revenue, 10x new customers and boost your brand visibility by providing insights to improve your business.</div>
            <div className={css.cards}>
                <Card4 imgSrc={globIcon} title="500+ cities" tagLine="in India" />
                <Card4 imgSrc={calenderIcon} title="2.5 lakhs+" tagLine="shops listings" />
